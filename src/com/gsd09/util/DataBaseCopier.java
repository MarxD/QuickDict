...
public class DataBaseCopier {
  ...
  Builder builder = new AlertDialog.Builder(mContext).setTitle("请稍等").setMessage("初次载入，词库文件导出中").setCancelable(false);
  //读取assets/$(subDirectory)目录下的filelist.lst文件，得到需要copy的文件列表
  ...
  /**
   *  获取需要拷贝的文件列表（记录在assets/filelist.lst文件中）
   *  @return 文件列表
   *  @throws IOException
   */
