...
import com.gsd09.util.DataBaseCopier;
...
public class MainActivity extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			new DataBaseCopier(this).copy();//董嘉楠 程序载入时进行判断，将数据库复制至专属文件夹,Android/data/data/com.gsd09.QuickDict/files/Dict/MyDict.db
		} catch (IOException e) {
			// TODO Auto-generated catch block
			Toast.makeText(this, "词库导出出错，本地词库可能无法使用", Toast.LENGTH_SHORT).show();
			LogUtil.i("copy", e.toString());
		}
